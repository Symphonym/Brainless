...
Item("Newspaper", "NewspaperItem", "SmallNewspaperItem", id)
{
	...
	m_examineString = "\"The mayor neglected to put out the fire caused by his pipe and I don't care very much I quit, Joe I had an affair with your byfriend, have fun with that.\" That makes sense. Maybe?";
}
